...
At context thresholds (per AGENTS.md > Context Quality Curve), the orchestrator should:
...
These boundaries supplement the universal safety boundaries in `AGENTS.md`. See also `agent_reference/BOUNDARIES.md` > Ad Hoc Collaboration Mode.
