...
These boundaries supplement the universal safety boundaries in `AGENTS.md`. The detailed execution boundaries in `agent_reference/BOUNDARIES.md` do not apply to Data Lookup mode (no code execution, no data transformations, no commits).
