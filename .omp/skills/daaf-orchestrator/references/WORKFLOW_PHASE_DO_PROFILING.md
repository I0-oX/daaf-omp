...
**AGENT PROTOCOL:** Read `.omp/agents/data-ingest.md`. Execute ONLY Part A work (scripts 01-03).
...
**AGENT PROTOCOL:** Read `.omp/agents/data-ingest.md`. Execute ONLY Part B work (scripts 04-06).
Read `agent_reference/SCRIPT_EXECUTION_REFERENCE.md` for the file-first protocol.
...
**AGENT PROTOCOL:** Read `.omp/agents/data-ingest.md`. Execute ONLY Part C work (scripts 07-09, + 07b if HIERARCHICAL).
Read `agent_reference/SCRIPT_EXECUTION_REFERENCE.md` for the file-first protocol.
...
**AGENT PROTOCOL:** Read `.omp/agents/data-ingest.md`. Execute ONLY Part D work (scripts 10-11).
Read `agent_reference/SCRIPT_EXECUTION_REFERENCE.md` for the file-first protocol.
...
**AGENT PROTOCOL:** Read `.omp/agents/code-reviewer.md`. This is a Data Onboarding QA review (not Full Pipeline) — there is no Plan.md. Use the context below for methodology alignment instead.
...
Read your agent protocol at `.omp/agents/data-ingest.md`.
