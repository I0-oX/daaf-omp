...
**Important:** In data research pipelines (see `AGENTS.md`), statsmodels analyses are executed through **script files**, not interactively. This ensures auditability and reproducibility.
