...
**Important:** In data research pipelines (see `AGENTS.md`), svy analyses are executed through **script files**, not interactively. This ensures auditability and reproducibility.
