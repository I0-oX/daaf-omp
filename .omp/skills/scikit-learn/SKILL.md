...
**Important:** In data research pipelines (see `AGENTS.md`), scikit-learn analyses are executed through **script files**, not interactively. This ensures auditability and reproducibility.
