...
**Important:** In data research pipelines (see `AGENTS.md`), spatial operations are executed through **script files**, not interactively. This ensures auditability and reproducibility.
