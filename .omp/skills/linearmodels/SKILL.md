...
**Important:** In data research pipelines (see `AGENTS.md`), linearmodels estimation is executed through **script files**, not interactively. This ensures auditability and reproducibility.
