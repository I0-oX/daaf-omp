...
**Important:** In data research pipelines (see `AGENTS.md`), all visualizations are generated through **script files** in `scripts/stage8_analysis/`, not interactively. This ensures auditability and reproducibility.
