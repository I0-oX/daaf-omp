...
**Important:** In data research pipelines (see `AGENTS.md`), Polars transformations are executed through **script files**, not interactively. This ensures auditability and reproducibility.
