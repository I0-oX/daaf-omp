...
| `.omp/skills/daaf-orchestrator/references/full-pipeline-mode.md` (dispatch via OMP `task`; error recovery is OMP-native) | If Final Review details needed | Goal-backward verification, traditional review checklist, review outcome |
