...
### Ask First Before
- Modifying AGENTS.md (universal authority document — see risk categories below)
...
**AGENTS.md Modification Risk Categories:**
...
### Never Do
- Create or modify files in `.omp/hooks/` (deny-edited by permission rules)
...
- Changes to safety-critical files (AGENTS.md, settings.json, hooks)
...
| Existing content contradicts AGENTS.md | STOP — AGENTS.md is authoritative; report the discrepancy |
...
**Invocation type:** `agent: "framework-engineer"`

The invocation template with full context fields is in `.omp/skills/daaf-orchestrator/references/framework-development-mode.md`.
